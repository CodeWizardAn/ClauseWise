...
import type { Checklist } from "@/lib/omission";
...
const LOAN_CHECKLIST: Checklist = {
  type: "loan",
...
const RENTAL_CHECKLIST: Checklist = {
  type: "rental",
...
const CHECKLISTS: Partial<Record<DocumentType, Checklist>> = {
  loan: LOAN_CHECKLIST,
  rental: RENTAL_CHECKLIST,
};

/** The checklist for a type, falling back to the generic one. */
export function checklistFor(type: DocumentType): Checklist {
