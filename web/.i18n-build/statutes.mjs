...
export const STATUTES = {
    "contract-act-1872": {
        ...
        scope: "central",
        summary: "The baseline law for every agreement in India — what makes a contract valid, what makes a term unenforceable, and what happens on breach.",
    },
    "registration-act-1908": {
        ...
        scope: "central",
        summary: "Sets out which documents must be registered with the sub-registrar. Leases of immovable property beyond a short term fall within it, and an unregistered document that should have been registered carries much less weight as evidence.",
    },
    "transfer-of-property-1882": {
        ...
        scope: "central",
        summary: "Governs leases of immovable property, including how a lease is created and the rights and duties of landlord and tenant.",
    },
    "model-tenancy-2021": {
        ...
        scope: "model",
        summary: "A central template for modern tenancy law, covering written agreements, deposit limits, notice periods and rent authorities.",
        caveat: "This is a model law circulated to states, not law by itself. It applies only where your state has enacted its own version.",
    },
    "state-rent-control": {
        id: "state-rent-control",
        name: "State Rent Control Acts",
        scope: "state",
        summary: "Each state has its own rent legislation, which can cap deposits, restrict eviction and set notice requirements.",
    ...
    "stamp-act-1899": {
        ...
        scope: "state",
        summary: "Sets the stamp duty payable on an instrument. An insufficiently stamped agreement can face difficulties when produced as evidence.",
    ...
    "negotiable-instruments-1881": {
        ...
        scope: "central",
        summary: "Governs cheques and promissory notes, including the consequences of a cheque being dishonoured.",
    },
    "rbi-fair-practices": {
        id: "rbi-fair-practices",
        name: "RBI Fair Practices Code for Lenders",
        scope: "regulator",
        summary: "Reserve Bank of India directions requiring regulated lenders to disclose terms clearly, keep penal charges reasonable and proportionate, and run a grievance redressal process.",
        caveat: "These are regulatory directions binding on RBI-regulated lenders. An unregulated private lender may not be covered.",
    },
};
